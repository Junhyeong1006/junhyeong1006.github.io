...
<head>
  <meta charset="UTF-8">
  <title>병원 홈페이지 카테고리 메뉴</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
    <style>body {
        background: linear-gradient(to bottom right, #2d3999, #a0bfff 80%);
        min-height: 100vh;
  ...
  <script>// script.js
    ...
    document.querySelector('.search-input').addEventListener('input', function(e) {
      ...
      document.querySelectorAll('.category-list li').forEach(li => {
        const text = li.querySelector('.category').textContent.toLowerCase();
...
<body>
    ...
    <div class="menu-container">
      ...
      <div class="menu-group">
        ...
        <div class="menu-item has-submenu">
          <span class="icon">👥</span>
          <span class="text">환자 관리</span>
          <div class="submenu">
            <div class="submenu-item">신규 등록</div>
            <div class="submenu-item">진료 기록</div>
            <div class="submenu-item">결제 관리</div>
          </div>
        </div>

        <div class="menu-item">
          <span class="icon">📅</span>
          <span class="text">예약 관리</span>
        </div>

        <div class="menu-item has-submenu">
          <span class="icon">💊</span>
          <span class="text">진료과목</span>
          <div class="submenu">
            <div class="submenu-item">내과</div>
            <div class="submenu-item">정형외과</div>
            <div class="submenu-item">신경과</div>
          </div>
        </div>
      </div>
    </div>
  ...
  <script>document.addEventListener('DOMContentLoaded', () => {
    ...
    document.addEventListener('click', () => {
      menuItems.forEach(i => i.classList.remove('active', 'hover'));
    });
  
    // 서브메뉴 호버 상태 유지
    document.querySelectorAll('.submenu').forEach(sub => {
      sub.addEventListener('mouseenter', () => {
        sub.parentElement.classList.add('hover');
      });
      sub.addEventListener('mouseleave', () => {
        sub.parentElement.classList.remove('hover');
      });
    });
  });
  </script>
